CREATE TABLE [dbo].[IndianStockScores]
(
    ...
    [ScoredAt]              DATETIME2     NOT NULL CONSTRAINT [DF_IndianStockScores_ScoredAt] DEFAULT GETUTCDATE(),

    CONSTRAINT [PK_IndianStockScores] PRIMARY KEY CLUSTERED ([Ticker]),
    CONSTRAINT [FK_IndianStockScores_IndianTickers] FOREIGN KEY ([Ticker]) REFERENCES [dbo].[IndianTickers]([Ticker])
);
