CREATE TABLE [dbo].[IndianRegimeSnapshots]
(
    ...
    [EvaluatedCount]           INT            NOT NULL CONSTRAINT [DF_IndianRegimeSnapshots_EvaluatedCount] DEFAULT (0),
    ...
    [Available]                BIT            NOT NULL CONSTRAINT [DF_IndianRegimeSnapshots_Available] DEFAULT (0),
    ...
    [ConditionAvailable]       BIT            NOT NULL CONSTRAINT [DF_IndianRegimeSnapshots_ConditionAvailable] DEFAULT (0),
    ...
    [BreadthPositiveSignals]   INT            NOT NULL CONSTRAINT [DF_IndianRegimeSnapshots_BreadthPositive] DEFAULT (0),
    [BreadthAvailableSignals]  INT            NOT NULL CONSTRAINT [DF_IndianRegimeSnapshots_BreadthAvail] DEFAULT (0),
    [BreadthAvailable]         BIT            NOT NULL CONSTRAINT [DF_IndianRegimeSnapshots_BreadthAvailable] DEFAULT (0),
